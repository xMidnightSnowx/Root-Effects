...
private _attached = (_radiuspos nearEntities ["AllVehicles", 5]) param [0, objNull];

if (isNull _attached) exitWith { ["Place Module on an object!"] call zen_common_fnc_showMessage; };

["Object Settings",[
	["TOOLBOX:YESNO",["Enable Damage","If true, the object will take damage and can be killed/destroyed."],false],
	["TOOLBOX:YESNO",["Enable Simulation","If true, the object will be simulated as normal."],false],
	["SLIDER",["Elevation","Adjust the height of the object in meters."],[0,1000,5,2]],
	["TOOLBOX:YESNO",["Enable Slide","If true, the object will slide around the area."],false],
	["SLIDER",["Slide Velocity","Distance in meters the object will be moved in each loop."],[0,10,0,2]],
	["SLIDER",["Slide Distance","Maximum distance in meters the object will slide during slide animation, slide movement is dependat on objects direction."],[0,100,0,2]],
	["TOOLBOX:YESNO",["Enable Bounce","If true, the object will bounce around the area."],false],
	["SLIDER",["Bounce Speed","Distance in meters the object will be moved in each loop."],[0,10,0,2]],
	["SLIDER",["Bounce Altitude","Determines how high and low the object will bounce in meters from initial altitude."],[0,100,0,2]],
	...
	["SLIDER",["Roll Velocity","Rolling speed in radiants."],[0,10,0,2]],
	...
	["SLIDER:RADIUS",["Orbit Radius","Orbit radius in meters around initial position of the object."],[5,1000,10,0,_radiuspos,[7,120,32,1]]],
	["SLIDER",["Orbit Speed","Speed in meters."],[0,50,0.10,2]],
	["TOOLBOX:YESNO",["Enable Distance Dependent","If true, the animation will be suspended until the player gets in range."],[false]],
	["SLIDER:RADIUS",["Activation Distance","Minimum distance in meters of players to object in order for object to be animated, if player is out of defined range the animation will be suspended until the player gets in range."],[100,5000,500,0,_radiuspos,[7,120,32,1]]]
	],{
		...
		[_attached,[_slidevel,_slidedist],[_bouncespeed,_bouncealtitude],[_rotvel,_rotateclockwise],_rollvel,[_orbitradius,_orbitspeed,_orbitclockwise],_dist,_elevation,_allow_damage,_allow_simulation] execVM "\Root_Effects\Root_FloatingObjects\AL_floating_mountain\float_main.sqf";
	},{
		["Aborted"] call zen_common_fnc_showMessage;
		playSound "FD_Start_F";
	}, _attached] call zen_dialog_fnc_create;
