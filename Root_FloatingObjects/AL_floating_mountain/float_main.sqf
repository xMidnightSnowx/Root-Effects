...
null= [[_nclass,_slide_move,_bounce_move,_rot_move,_roll_vel,_orbit_move,_dist_dependent,_poz_obj,_alt_obj,_allow_damage,_allow_simulation],"\Root_Effects\Root_FloatingObjects\AL_floating_mountain\float_obj.sqf"] remoteExec ["BIS_fnc_execVM",0,true];