...
["Object Settings",[
	...
	["SLIDER",["Eruption Delay","Delay in seconds between Volcano Eruptions."],[10,600,600,0]],
	...
	["EDIT:MULTI",["Protective Gear","Comma (,) seperated classnames (without spaces) of the items considered as 'Protective Gear' near crater."],["B_Kitbag_mcamo",{},4]]
		...
		[_object, _radius, _eruptionDelay, _enableCraterLava, _enableLightning, _enableLavaFlow, _enableLethality, _protectiveGear] execVM "\Root_Effects\Root_Volcano\AL_volcano\volcano_main.sqf";
	},{
